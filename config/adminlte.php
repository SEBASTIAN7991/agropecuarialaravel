...
return [
    ...
    */
    ...
    'layout_topnav' => null,//navegador acostado
    'layout_boxed' => null,
    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'can'  => 'admin.visitas.index',
        ],
        [
            'text' => 'Fierro Marcador',
            'route'  => 'fierros.index',
            'icon' => 'fas fa-fw fa-anchor',
            'can'  => 'admin.fierros.index',
        ],
        [
            'text' => 'Oficios',
            'route'  => 'oficios.index',
            'icon' => 'fas fa-fw fa-anchor',
            'can'  => 'admin.oficios.index',
        ],
        [
            'text' => 'Comisiones',
        ...
        [
            ...
            'can'  => 'admin.organizaciones.index',
        ],
        [
            'text' => 'Regiones',
            'route'  => 'regiones.index',
            'icon' => 'fas fa-fw fa-globe',
            'can'  => 'admin.regiones.index',
        ],
        [
            'text' => 'Localidades',
            'route'  => 'localidades.index',
            'icon' => 'fas fa-fw fa-map',
            'can'  => 'admin.localidades.index',
        ],
        [
            'text' => 'Proyectos',
    ...
    'plugins' => [
        ...
        'Sweetalert2' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,//cuando es local los archivos
